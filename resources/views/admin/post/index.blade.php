                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    @foreach($posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-success waves-effect btn-sm"> <i class="material-icons">visibility</i></a>
                                                <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-info waves-effect btn-sm"> <i class="material-icons">edit</i></a>
